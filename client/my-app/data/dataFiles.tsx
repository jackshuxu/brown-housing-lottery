...
export const api = [
  { state: "California", county: "King", percentage: 83.5 },
  { state: "California", county: "San Francisco", percentage: 87.1 },
  { state: "New York", county: "Queens", percentage: 78.4 },
  { state: "New York", county: "Bronx", percentage: 90.2 },
];
